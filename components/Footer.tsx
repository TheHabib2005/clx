...
const Footer = async () => {
    ...
    return (
        <footer className="text-sm text-neutral-500 dark:text-neutral-400  md:pb-0 pb-[60px]    w-full">
            <div className="mx-auto flex  flex-col gap-6 border-t border-neutral-200 px-6 py-6 text-sm md:flex-row md:gap-12 md:px-4  dark:border-neutral-700">
                <div className=''>
                    <Link
